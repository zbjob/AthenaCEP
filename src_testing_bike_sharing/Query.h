...
struct Query
{
	...
	enum DefinedAttributes
	{
        ...
        DA_TIMESTAMP_ATTR1 = PatternMatcher::MAX_ATTRIBUTES-7,
        DA_TIMESTAMP_ATTR2 = PatternMatcher::MAX_ATTRIBUTES -8,
        DA_TIMESTAMP_ATTR3 = PatternMatcher::MAX_ATTRIBUTES-9,
